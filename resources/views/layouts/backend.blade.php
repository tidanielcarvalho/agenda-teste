...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <!-- DataTable -->
        <link href="{{ cdn_asset('/css/layout-datatable.css') }}" rel="stylesheet" type="text/css">
        <!-- datetimepicker -->
    ...
    <body class="hold-transition {{ config('adminlte.theme') }} sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <footer class="main-footer text-center">
                <strong>Desenvolvido por <a href="https://www.linkedin.com/in/daniel-carvalho-7844b6107/">Daniel Carvalho</a></strong>
            </footer>
        </div>
        <!-- ./wrapper -->
        ...
        <!-- DataTable -->
        <script src="{{ cdn_asset('/adminlte/plugins/dataTable/jquery.dataTables.min.js') }}" type="text/javascript"></script>
        <!-- Tabela Visualizar Contatos -->
        <script src="{{ cdn_asset('/js/script-datatable.js') }}"></script>
        <!-- Via Cep -->
        <script src="{{ cdn_asset('/js/viaCep.js') }}"></script>
        <!-- Mask -->
